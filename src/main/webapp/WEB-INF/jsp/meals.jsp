...
<section>
    <h3><a href="http://localhost:8080/topjava"><spring:message code="ref.home"/></a></h3>
    <hr/>
    <h2><spring:message code="filter.meals"/></h2>
    <form method="get" action="meals/filter">
        ...
        <button type="submit"><spring:message code="filter.submitButton"/></button>
    </form>
    <hr/>
    <a href="meals/create"><spring:message code="ref.addMeal"/></a>
    <br><br>
