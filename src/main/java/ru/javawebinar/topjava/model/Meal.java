...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.ALL_SORTED_BETWEEN_HALF_OPEN, query = "SELECT m FROM Meal m LEFT JOIN FETCH m.user " +
...
public class Meal extends AbstractBaseEntity {
    ...
    public static final String ALL_SORTED_BETWEEN_HALF_OPEN = "Meal.getBetweenHalfOpen";
